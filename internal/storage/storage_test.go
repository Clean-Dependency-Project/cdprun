...
func createTestDownload(runtime, version, platform, arch string) *Download {
	return &Download{
		...
		LocalPath:          "/tmp/node-v18.20.8-darwin-arm64.tar.gz",
...
func TestParseSemver(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "two-component version - major.minor treated as patch 0",
			version:   "1.2",
			wantMajor: 1,
			wantMinor: 2,
			wantPatch: 0,
		...
		{
			name:      "intellij year-based version 2026.1",
			version:   "2026.1",
			wantMajor: 2026,
			wantMinor: 1,
			wantPatch: 0,
		...
		{
			name:      "intellij year-based version 2025.3",
			version:   "2025.3",
			wantMajor: 2025,
			wantMinor: 3,
			wantPatch: 0,
